...
public class InstitutionSetupActivity extends AppCompatActivity {
    ...
    private DatabaseReference mDatabaseInstitutions;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_institution_setup);
        ...
        SetupImageViewBtn = findViewById(R.id.inst_setup_image);
        SetupImageBtn = findViewById(R.id.inst_setup_image_btn);
        NameEditText = (EditText)findViewById(R.id.inst_setup_name);
        EmailEditText = findViewById(R.id.inst_setup_email);
        PhoneEditText = findViewById(R.id.inst_setup_phone);
        SubmitBtn =(Button)findViewById(R.id.inst_setupFinishBtn);
    ...
    private void startSetupAccout() {
            ...
            Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        mDatabaseInstitutions.child(user_id).child("name").setValue(name_);
                        mDatabaseInstitutions.child(user_id).child("email").setValue(email_);
                        mDatabaseInstitutions.child(user_id).child("number").setValue(phone_);
                        mDatabaseInstitutions.child(user_id).child("profile_uri").setValue(downloadUri);
                        mProgress.dismiss();
                        Intent mainIntent = new Intent(InstitutionSetupActivity.this, MainActivity.class);
                    ...
                    {
                        Toast.makeText(InstitutionSetupActivity.this, "Updating user details encountered some error. Try again.", Toast.LENGTH_SHORT).show();
                    }
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    Toast.makeText(InstitutionSetupActivity.this, "Error : "+e.toString(), Toast.LENGTH_SHORT).show();
        ...
        else  if(!TextUtils.isEmpty(NameEditText.getText().toString().trim()) && !TextUtils.isEmpty(EmailEditText.getText().toString().trim())  && !TextUtils.isEmpty(PhoneEditText.getText().toString().trim())  && mImageUri == null)
        {
            ...
            mDatabaseInstitutions.child(user_id).child("name").setValue(name_);
            mDatabaseInstitutions.child(user_id).child("email").setValue(email_);
            mDatabaseInstitutions.child(user_id).child("number").setValue(phone_).addOnCompleteListener(new OnCompleteListener<Void>() {
                @Override
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                Toast.makeText(InstitutionSetupActivity.this,err,Toast.LENGTH_LONG).show();
            }
        }
    }
